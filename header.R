...
HF_Dir<-file.path('/Users/dmorgan/Sync/_dev/Biodiversity/BC_HumanFootprint')
ProvData<-file.path('../data')
EC_Dir<-file.path('/Users/dmorgan/Sync/ecological_corridors/02_data')
