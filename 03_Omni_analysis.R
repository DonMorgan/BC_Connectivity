...
OS_ini<-c("[Input files]",
          paste("resistance_file = ",file.path(ConnDir,"resistance_surface_AOI.tif")), #ground_file with ground_file_is_resistances=True
          paste("source_file = ", file.path(ConnDir,"source_surface_AOI.tif")), #source_file
          "[Options]",
          ...
          #paste("project_name = ",file.path(RunDir),sep=''),
